      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../netting/islem.php" method="POST">
            ...
            <h1 style="color: #440a53;">Üye Ol</h1>
            ...
            <div>
            <button style="width: 60%; background-color: #440a53; color:white;" type="submit" name="kullanicikaydet" class="btn btn-default">Üye Ol</button>
          ...
          <a href="saticiuyeol.php"><button style="width: 60%; background-color: #440a53; color:white;" type="submit" name="" class="btn btn-default">Satıcı Olarak Üye Ol</button></a>
