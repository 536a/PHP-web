  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Ürünleriniz<small>
               <a href="urun-ekle2.php?user=satici"><button class="btn btn-primary btn-xs"><big>+</big></button></a>
              <?php 
          ...
          <div class="x_content">
            ...
            <td><center><a href="../netting/islem.php?urun_id=<?php echo $uruncek['urun_id']; ?>&urunsil=ok&&user=satici"><button class="btn btn-danger btn-xs">Sil</button></a></center></td>
          </tr>
